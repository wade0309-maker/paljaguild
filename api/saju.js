// api/saju.js — Claude API (Anthropic) 사주풀이
export const config = { runtime: 'edge' };

const SYSTEM_PROMPT = `당신은 자평명리학과 현대 통계학을 결합하여 프리미엄 인생 전략 리포트를 제공하는 수석 컨설턴트입니다. 입력된 사주 데이터를 분석하여 아래 형식으로 출력하십시오.
...
### [4] 본질과 현실 페르소나
타이틀, MBTI, 3단 논법으로 기질/최적환경/최악환경 분석
